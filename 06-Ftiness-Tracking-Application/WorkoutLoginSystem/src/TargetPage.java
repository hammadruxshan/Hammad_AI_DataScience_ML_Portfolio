...
public class TargetPage extends JPanel{
    JFrame frame;
    ...
    public TargetPage () {
        ...
        JLabel titleLabel = new JLabel("Target", SwingConstants.CENTER);
        ...
        addLabeledField(formPanel, gbc, "Bust/Chest(cm)", 2);
        addLabeledField(formPanel, gbc, "Waist(cm)", 3);
        addLabeledField(formPanel, gbc, "Hips(cm)", 4);
        addLabeledField(formPanel, gbc, "Thighs(cm)", 5);
        addLabeledField(formPanel, gbc, "Calves(cm)", 6);
        addLabeledField(formPanel, gbc, "Arms(cm)", 7);
